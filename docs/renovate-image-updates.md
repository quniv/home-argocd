...
infrastructure images, Velero, and PostgreSQL. It runs weekly before 06:00 UTC
on Tuesday and creates draft pull requests only. It never deploys directly,
merges automatically, or receives cluster, Argo CD, registry, or secret-manager
credentials.
